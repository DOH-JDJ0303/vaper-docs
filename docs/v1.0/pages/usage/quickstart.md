...
grand_parent: v1.0
parent: Usage Guide
permalink: /docs/v1.0/pages/usage/quickstart/
---
...
{: .note}
This uses the **default reference set**, which includes <span id="taxon-count">[loading]</span> viral taxa ([full list](../../ref_search/)). It is also possible to supply your own reference(s) in the samplesheet or via the `--refs` parameter ([learn more](../overview/#reference-selection)).
```
